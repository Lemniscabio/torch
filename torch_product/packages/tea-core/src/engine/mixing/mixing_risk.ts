...
import type { ProcessInputs, DerivedParameters, MixingRiskResult, RiskScore, Confidence, AssessmentFlag } from "../../types";
import { O2_MIXING_THRESHOLDS, FEEDING_FREQUENCY_SECONDS } from "../../constants";
...
export function calculateMixingRisk(
  ...
  return {
    result: {
      ...
      theta_mix_lab,
      theta_mix_lab_std,
      theta_mix_lab_min:    ensLab.min,
      theta_mix_lab_max:    ensLab.max,
      theta_mix_target,
      theta_mix_target_std,
      theta_mix_target_min: ensTarget.min,
      theta_mix_target_max: ensTarget.max,
