    ...
    <main className="min-h-dvh px-6 py-8" style={{ background: 'var(--color-paper-50)' }}>
      ...
      {isExample ? (
        ...
        >
          ...
          <Link href="/assess" className="text-[13px] font-medium" style={{ color: 'var(--color-results-accent)' }}>
      ...
      >
        ...
        <div className="mt-8 divide-y" style={{ borderColor: 'var(--color-rule)' }}>
          <section className="pb-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.14em]" style={{ color: 'var(--color-results-accent)' }}>
              Primary Bottleneck
            </p>
