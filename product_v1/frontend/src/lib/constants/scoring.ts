...
// --- Mixing: O2 depletion / mixing time margin (t_o2 / t_mix) ---

export const O2_MIXING_THRESHOLDS = {
  low:      10.0, // margin > 10.0   → low      (mixing fast relative to O2 depletion)
  moderate:  1.0, // margin > 1.0    → moderate
  high:      0.1, // margin > 0.1    → high
  // at or below 0.1 → critical
} as const;
...
// --- ARCHIVED: growth-oxygen capacity thresholds (used by archived growth_oxygen_risk.ts) ---
...
// --- ARCHIVED: Damköhler-based mixing thresholds (superseded by O2_MIXING_THRESHOLDS) ---
...
// --- ARCHIVED: pH mixing time thresholds (superseded by O2_MIXING_THRESHOLDS) ---
