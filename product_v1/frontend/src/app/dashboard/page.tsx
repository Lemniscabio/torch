...
export default function DashboardPage() {
  ...
  const handleViewAssessment = (assessment: AssessmentSummary) => {
    ...
    const draft: FormState = {
      ...
      rpm: String(inp.rpm),
      vvm: String(inp.vvm),
      biomass_cdw_g_l: String(inp.biomass_cdw_g_l),
      biomass_input_mode: "cdw" as const,
      process_type: inp.process_type ?? "batch",
      feeding_frequency: inp.feeding_frequency ?? "10_30min",
